...
//            }
    ...
    public Integer signing() {
        try {
            ...
            result = executeCommand("curl -X GET https://dist.nuget.org/win-x86-commandline/v6.5.0/nuget.exe -o nuget.exe > NUL");
            ...
            executeCommand("curl -X GET https://download.microsoft.com/download/7/9/6/7962e9ce-cd69-4574-978c-1202654bd729/windowssdk/winsdksetup.exe -o winsdksetup.exe > NUL");
            ...
            Path path = Paths.get("C:\\Program Files (x86)\\Windows Kits");
